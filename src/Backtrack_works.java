...
public class Backtrack_works {
	...
	public static void main(String[] args) {
		Backtrack_works backtrack = new Backtrack_works();
		System.out.println(backtrack.backtrack(true, 0));
	}
	
	public Backtrack_works(byte[] start1Nums, byte[] start2Nums)
	{
	 ...
	 */
	public Backtrack_works(byte[] grid)
	{
