 ...
 *
 */
public class BacktrackPlayerTwo {
...
//	public static final int symmetryDepth = 17;
    public static final int storeDepth = 10;//10;//9;
	
	public static final int symmetryDepth = 5;//5;//5;
	...
	public static void main(String[] args) {
		BacktrackPlayerTwo backtrack = new BacktrackPlayerTwo();
		System.out.println(backtrack.backtrack(true, 0));
	}
	
	public BacktrackPlayerTwo(byte[] start1Nums, byte[] start2Nums)
	{
	 ...
	 */
	public BacktrackPlayerTwo(List<Byte> grid)
	{
		initializeClosed();
