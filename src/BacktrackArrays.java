...
//	public static final int storeDepth = 17; //store everything mothafucka
	...
	public static void main(String[] args) {
		BacktrackArrays backtrack = new BacktrackArrays();
		System.out.println(backtrack.backtrack(true, 0));
	}
	
	public BacktrackArrays(byte[] start1Nums, byte[] start2Nums)
	{
	 ...
	 */
	public BacktrackArrays(byte[] grid)
	{
		initializeClosed();
